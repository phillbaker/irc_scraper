...
SQL
  ...
  def find_page_history info
    ...
    [res.first['pages'].first['page'].first['revisions'].last['rev'].first['revid'], Time.parse(res.first['pages'].first['page'].first['revisions'].last['rev'].first['timestamp']).to_i, source, res3.first['pages'].first['page'].first['counter'].to_i, res3.first['pages'].first['page'].first['length'].to_i]
